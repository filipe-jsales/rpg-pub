...
public abstract class Character: IRpgObject, IMagicalRpgObject, ILeveling, IEquipment
{
    ...
    public int Level { set => SetLevel(value); }
    public double Experience { set => SetExperience(value); }
    public Armor Armor { set => SetEquippedArmor(value); } 
    public Weapon Weapon { get => GetEquippedWeapon(); set => SetEquippedWeapon(value); }
    public double HealthFactor { set => SetHealth(value); }
    public double DamageFactor { set => SetBaseDamage(value); }
    public int PoiseFactor { set => SetBasePoise(value); }
    public double MagicFactor { set => SetMana(value); }
    public string ElementalFactor { set => SetElementalAffinity(value); }
}
